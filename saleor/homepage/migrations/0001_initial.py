# Generated by Django 2.0.3 on 2018-03-27 16:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('html_classes', models.CharField(default='col-sm-12 col-md-6', max_length=100, validators=[django.core.validators.MaxLengthValidator(100)])),
                ...
                ('position', django_positions_2.fields.PositionField(default=-1)),
            ...
            options={
                'permissions': (('view_blocks_config', 'Can view home page configuration'), ('edit_blocks_config', 'Can edit home page configuration')),
            },
        ),
    ]
