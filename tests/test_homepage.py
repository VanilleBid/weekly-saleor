...
from saleor.homepage.models import HomePageItem, DEFAULT_HTML_CLASSES, DEFAULT_PRIMARY_BTN_TEXT
...
def test_homepage_block_set_cover(homepage_block: HomePageItem, product_image):
    ...
    with mock.patch.object(SizedImage, 'create_resized_image'):
        assert homepage_block.cover_url == '/media/__sized__/product-thumbnail-1080x720-70.jpg'
